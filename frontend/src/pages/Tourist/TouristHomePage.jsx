    ...
    <div className="bg-gray-100 min-h-screen text-gray-800">
      <header className="flex justify-between items-center p-6 bg-opacity-90 backdrop-blur-lg shadow-md rounded-lg">
        <div className="flex flex-col">
          ...
          <h2 className="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-blue-500">
            :::one jot at a time!
          </h2>
        </div>
        <NavigationHeader />
      ...
      <div className="container mx-auto mt-8 px-4">
          ...
          <button
            className={`tab-btn ${
              activeTab === "Activities"
                ...
                : "text-white-600"
            } hover:bg-blue-600 hover:text-white py-2 px-6 rounded-lg shadow-md transition duration-300`}
        ...
        {/* Filters */}
        <div className="filters mb-6 p-8 bg-gray-200 rounded-lg shadow-xl">
