...
const App = () => {
  return (
    <Routes>
      ...
      />
      <Route path="/tourist/homePage/bookmarks" element={<BookMarks />} />
      <Route path="/products" element={<ShowProducts />} />
      <Route path="/products/addProduct" element={<AddProduct />} />
      <Route path="/products/editProduct/:id" element={<EditProduct />} />
      <Route path="/products/archive" element={<ProductList />} />
      <Route
      ...
      />
      <Route path="tourist/homePage/products/cart" element={<TouristCart />} />
      ...
      />
      <Route path="/admins/change-password" element={<AdminChangePassword />} />
      <Route
      ...
      <Route path="/completed" element={<ActivityList />} />
      <Route
      ...
      />
      <Route path="/admins/complaints" element={<AdminComplain />} />
      ...
      <Route path="/activities/:id" element={<SharedActivityPage />} />
      <Route path="/itineraries/:id" element={<SharedItineraryPage />} />
      <Route path="/attractions/:id" element={<SharedAttractionPage />} />
      <Route path="/forgot-password" element={<RequestOTP />} />
      <Route path="/verify-otp" element={<VerifyOTP />} />
      <Route path="/reset-password" element={<ResetPassword />} />
      <Route path="/Governor" element={<GovernorDashBoard />} />
      <Route path="/activity-revenue" element={<ActivityRevenue />} />
      <Route path="/itinerary-revenue" element={<ItineraryRevenue />} />
      <Route path="/attraction-revenue" element={<AttractionRevenue />} />
      <Route path="/product-revenue" element={<ProductRevenue />} />
      <Route path="/select-revenue" element={<Revenue />} />
      <Route
      ...
      />
      <Route path="/tourist/homePage/flights" element={<FlightSearch />} />
      <Route path="/booked-flights" element={<BookedFlights />} />
      <Route path="/tourist/homePage/hotels" element={<HotelList />} />
      ...
      />
      <Route path="/mail-advertiser" element={<SendEmailToAdvertiser />} />
      <Route path="/mail-tour-guide" element={<SendEmailToTourGuide />} />
      <Route
      ...
      <Route path="/buy-tourist-cart" element={<BuyTouristCart />} />
      <Route path="/tourist/homePage/hotels" element={<HotelList />} />

      <Route path="/booked-hotels" element={<BookedHotels />} />
      <Route path="/tourist-address" element={<AddressManagement />} />
      <Route path="/tourist-orders" element={<PreviousPurchases />} />
      <Route path="/notify-seller-product" element={<NotifySellerProduct />} />
      <Route path="/notify-admin-product" element={<NotifyAdminProduct />} />
    </Routes>
  );
};
