...
// const deleteUserByType = require("../controllers/adminController");
// const addTourismGovernor = require("../controllers/adminController");
...
//       return res
//         .status(400)
//         .json({ message: "Admin already exists. This route is disabled." });
//     }
